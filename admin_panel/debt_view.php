...
try {
    $stmt = $pdo->prepare("SELECT debts.*, users.name AS user_name, users.block_number, users.apartment_number FROM debts LEFT JOIN users ON debts.user_id = users.id ORDER BY debts.due_date DESC LIMIT :limit OFFSET :offset");
...
<body>
<div class="container">
    <h1>Просмотр данных о коммунальных долгах</h1>
